...
# Released under a "Simlified BSD" lincese
...
def main():
    ...
    mousey = 0 # used to store y coorindate of mouse event
...
def getRandomizedBoard():
    # Get a list of every possivle shape in every possible color.
    icons = []
...
def hasWon(revealedBoxes):
    # Returns Ture if all the boxes have been revealed, otherwise False
