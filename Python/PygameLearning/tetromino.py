...
def main():
    ...
    while True: # game loop
        if random.randint(0, 1) == 0:
            pygame.mixer.music.load('sounds/tetrisb.mid')
        else:
            pygame.mixer.music.load('sounds/tetrisc.mid')
...
def runGame():
    ...
    while True: # main game loop
        ...
        # let the piece fall if is time to fall
...
def calculateLevelAndFallFreq(score):
    # Based on the score, return the level and player is on and
    # how many seconds [ass until a falling piece falls one space.
...
def removeCompleteLines(board):
    # Remove any complete lines on the board, move everything above them down, and return the number of complete lines.
    numLinesRemoved = 0
...
def drawBox(boxx, boxy, color, pixelx=None, pixely=None):
    ...
    # are specified, draw to the pixel coordinate stored in
